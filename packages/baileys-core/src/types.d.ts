 ...
 */
import type { WASocket, BaileysEventMap, WAMessage, WAMessageKey, Contact, GroupMetadata } from 'baileys';
export type { WASocket, BaileysEventMap, WAMessage, WAMessageKey, Contact, GroupMetadata, };
