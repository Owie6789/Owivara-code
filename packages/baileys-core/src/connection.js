...
export class ConnectionManager extends EventEmitter {
    ...
    async connect() {
        ...
        this.sock.ev.on('connection.update', async (update) => {
            ...
            if (connection === 'close') {
                ...
                const shouldReconnect = reason !== DisconnectReason.loggedOut && this.options.autoReconnect !== false;
                if (shouldReconnect) {
    ...
    async reconnect() {
        ...
        logger.info({ sessionId: this.options.sessionId, attempt: this.reconnectAttempts, delay }, 'Reconnecting...');
